...
Global $FontThemeColor = "0x000000" ; Font Color
Global $GUIBorderColor = "0x2D2D2D" ; GUI Border Color
Global $ButtonBKColor = "0x0078D7" ; Metro Button BacKground Color
Global $ButtonTextColor = "0xFFFFFF" ; Metro Button Text Color
Global $CB_Radio_Color = "0x2D2D2D" ;Checkbox and Radio Color (Box/Circle)
Global $GUI_Theme_Name = "DarkTealV2" ;Theme Name (For internal usage)
Global $CB_Radio_Hover_Color = "0xE6E6E6" ; Checkbox and Radio Hover Color (Box/Circle)
Global $CB_Radio_CheckMark_Color = "0xE6E6E6" ; Checkbox and Radio checkmark color

Func _SetTheme($ThemeSelect = "DarkTeal")
	$GUI_Theme_Name = $ThemeSelect
	Switch ($ThemeSelect)
		Case "Brighten"
			$GUIThemeColor = "0xFffffff"
			$FontThemeColor = "0x000000"
			$GUIBorderColor = "0xD8D8D8"
			$ButtonBKColor = "0x0078D7"
			$ButtonTextColor = "0xE6E6E6"
			$CB_Radio_Color = "0xE6E6E6"
			$CB_Radio_Hover_Color = "0xE6E6E6"
